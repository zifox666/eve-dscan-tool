const translations = {
  'zh': {
    ...
    'input_title': 'Dscan数据',
    'only_have_distance': '仅统计有距离信息的扫描结果',
    'add_ship': '手动添加侦查舰',
    'name': '名称',
    'num': '数量',
    'action': '操作',
    ...
    'local_dscan_title': '本地扫描分析结果',
    'total_characters': '总角色数',
    'total_corps': '总公司数',
    'total_alliances': '总联盟数',
    'no_alliances_characters': '无联盟角色',
    'alliance': '联盟',
    'corporation': '公司',
    'character': '角色',
    ...
    'ship_dscan_title': '舰船扫描分析结果',
    'system': '星系',
    'ship_count': '舰船数量',
    'total_count': '总数量',
    'capital_count': '旗舰数量',
    'structure_count': '建筑数量',
    'ship_type': '舰船类型',
    'ship_type_sub': '常规',
    'ship_type_cap': '旗舰',
    'ship_type_structure': '建筑',
    'ship_type_other': '其它',
    'ship_name': '舰船名称',
    'normal_ship': '常规',
    'capital_ship': '旗舰',
    ...
    'page_not_found_desc': '您访问的页面不存在或已被删除',
  },
  'en': {
    //index
    ...
    'input_title': 'DScan Data',
    'only_have_distance': 'Only analysis ships within visual range (WVR)',
    'add_ship': 'Manually add ships',
    'name': 'Name',
    'num': 'Number',
    'action': 'Action',
    'submit': 'Submit',
    ...
    'local_dscan_title': 'Local DScan Analysis',
    'total_characters': 'Total Characters',
    'total_corps': 'Total Corporations',
    'total_alliances': 'Total Alliances',
    'no_alliances_characters': 'No Alliances Characters',
    'alliance': 'Alliance',
    ...
    'ship_dscan_title': 'Ship DScan Analysis',
    'system': 'System',
    'ship_count': 'Ships',
    'total_count': 'Total',
    ...
    'ship_type': 'Ship Type',
    'ship_type_sub': 'Subs',
    'ship_type_cap': 'Capitals',
    'ship_type_structure': 'Structures',
    'ship_type_other': 'Others',
    'ship_name': 'Ship Name',
    'normal_ship': 'Normal Ship',
    ...
    // redirect
    'progress': 'Processing data, please wait...',
    ...
    'page_not_found_desc': 'The page you are looking for does not exist or has been deleted',
  }
};